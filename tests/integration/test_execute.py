...
INTERACTIVE_CLUSTER_TEMPLATES_PATH = {
    "AWS": "tests/integration/templates/interactive-aws.json",
    "Azure": "tests/integration/templates/interactive-azure.json"
}
CONDA_ENV_TEMPLATE_PATH = "tests/integration/templates/conda-env.yml"
